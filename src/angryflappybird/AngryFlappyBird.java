...
public class AngryFlappyBird extends Application {
    ...
    private void resetGameScene(boolean firstEntry) {
        ...
        int posY_egg_1 = DEF.SCENE_HEIGHT - DEF.PIPE_HEIGHT1 - 80;
        int posY_egg_2 = DEF.SCENE_HEIGHT - DEF.PIPE_HEIGHT2 - 80;
    	...
    	for (int i=0; i<DEF.PIPE_COUNT; i++) {
    	    ...
    	    if (rand_num1 == 0) {
                ...
                if (rand_num4 == 0) {                        
                    ...
                    Sprite pig = new Sprite(posX_pipe-20, posY_pig, DEF.IMAGE.get("pig"));
